...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { user_id: @ledger.user_id, whiskey_id: @ledger.whiskey_id } }, as: :json
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { user_id: @ledger.user_id, whiskey_id: @ledger.whiskey_id } }, as: :json
    assert_response 200
  end
